...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 12 13:15:12 2022
...
folder_location = '/Users/akhila/Documents/GitHub/Sideproject-1/raw downloaded files'
...
for n in fnmatch.filter(os.listdir(folder_location), '*.pdf*'):
    ...
    print(text)
    keywords = re.findall("microbiome",text)
